<template>
    <div>
        <b-form class="postForm" id="UploadForm" name="UploadForm">
            ...
            <b-form-group>
                <h4>Location:</h4>
                <autocomplete ref="gmapAutocomplete" @place_changed="setPlace" placeholder="Enter an address here..." class="field_location"></autocomplete>
            </b-form-group>
            ...
            <b-form-group id="input_image" label-for="input_image">
                ...
                required
                ></b-form-file>
                <div class="mt-3">Selected file: {{ file1 ? file1.name : '' }}<br/></div>
            ...
            <b-form-group style="text-align:left;">
                  <b-button size="lg" block variant="success" @click="create" type="submit">Upload</b-button>
            </b-form-group>

            <b-form-group style="text-align:center;" v-if="savingSuccessful">
                <b-button variant="primary" size="lg"><router-link :to="{ name: 'MainMap' }" style="text-decoration:none;color:white;">Return Home</router-link></b-button>
            </b-form-group>
        </b-form>
    </div>
</template>
